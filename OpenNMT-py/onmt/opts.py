...
def model_opts(parser):
    ...
    group.add_argument('-encoder_type', type=str, default='rnn',
                       choices=['rnn', 'brnn', 'mean', 'transformer', 'cnn','dnc'],
                       help="""Type of encoder layer to use. Non-RNN layers
                       are experimental. Options are
                       [rnn|brnn|mean|transformer|cnn|dnc].""")
    group.add_argument('-decoder_type', type=str, default='rnn',
                       choices=['rnn', 'transformer', 'cnn','dnc'],
                       help="""Type of decoder layer to use. Non-RNN layers
                       are experimental. Options are
                       [rnn|transformer|cnn|dnc].""")
    ...
    group.add_argument('-nr_cell', type=int, default=5,
                         help="NR Cell num of  Differentiable Neural Computers")
    group.add_argument('-read_heads', type=int, default=2,
                         help="Read head num of  Differentiable Neural Computers")
    group.add_argument('-cell_size', type=int, default=10,
                         help="Read head num of  Differentiable Neural Computers")
...
def preprocess_opts(parser):
    ...
    group.add_argument('-src_seq_length', type=int, default=300,
