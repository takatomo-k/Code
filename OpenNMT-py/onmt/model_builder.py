...
from onmt.encoders.mem_encoder import MEMEncoder

from onmt.decoders.decoder import InputFeedRNNDecoder, StdRNNDecoder
from onmt.decoders.transformer import TransformerDecoder
from onmt.decoders.cnn_decoder import CNNDecoder
from onmt.decoders.mem_decoder import MEMDecoder
...
def build_decoder(opt, embeddings):
    ...
    if opt.decoder_type == "transformer":
        ...
        return CNNDecoder(opt.dec_layers, opt.dec_rnn_size,
                          ...
                          embeddings)
    elif opt.decoder_type == "dnc":
        return MEMDecoder(opt.rnn_type,opt.dec_layers, opt.dec_rnn_size,opt.global_attention,
